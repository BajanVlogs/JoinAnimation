...
use JoinAnimation\commands\JoinCommand;
...
class Loader extends PluginBase{
    ...
    public function loadVirions(): void{
        foreach([
            ...
            if(!class_exists($class)){
                $this->getLogger()->error($virion . " virion not found. Please download JoinAnimation from Poggit-CI or use DEVirion (not recommended).");
    ...
    public function loadCommands(): void{
        Server::getInstance()->getCommandMap()->register("JoinAnimation", new JoinCommand($this));
    }
