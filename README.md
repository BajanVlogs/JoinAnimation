Sure, here's an updated version of your `README.md` file to reflect the changes made to your plugin and to provide instructions on how to configure custom sounds:
